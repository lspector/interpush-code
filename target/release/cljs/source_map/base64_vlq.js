...
var digit_27733 = (vlq & cljs.source_map.base64_vlq.vlq_base_mask);
var vlq_27734__$1 = (vlq >>> (5));
while(true){
if((vlq_27734__$1 > (0))){
var digit_27735__$1 = (digit_27733 | cljs.source_map.base64_vlq.vlq_continuation_bit);
sb.append(cljs.source_map.base64.encode(digit_27735__$1));

var G__27736 = (vlq_27734__$1 & cljs.source_map.base64_vlq.vlq_base_mask);
var G__27737 = (vlq_27734__$1 >>> (5));
digit_27733 = G__27736;
vlq_27734__$1 = G__27737;
continue;
} else {
sb.append(cljs.source_map.base64.encode(digit_27733));
}
break;
}
...
var G__27738 = i__$1;
var G__27739 = result__$1;
var G__27740 = shift__$1;
i = G__27738;
result = G__27739;
shift = G__27740;
continue;
