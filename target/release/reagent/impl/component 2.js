...
if((i < len)){
var k = (ks[i]);
var G__32064 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),goog.object.get(o,k));
var G__32065 = (i + (1));
m = G__32064;
i = G__32065;
continue;
...
var temp__5737__auto__ = p.argv;
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__32066 = p.children;
return reagent.impl.component.global$module$react.Children.toArray(G__32066);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32068 = c;
var G__32068__$1 = (((G__32068 == null))?null:G__32068.prototype);
if((G__32068__$1 == null)){
return null;
} else {
return G__32068__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__32070 = c;
var G__32070__$1 = (((G__32070 == null))?null:G__32070.prototype);
if((G__32070__$1 == null)){
return null;
} else {
return G__32070__$1.render;
}
})() == null)))));
});
...
var G__32072 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__32072) : reagent.impl.component.as_element.call(null,G__32072));
};
...
while (G__32075__i < G__32075__a.length) {G__32075__a[G__32075__i] = arguments[G__32075__i + 0]; ++G__32075__i;}
  args = new cljs.core.IndexedSeq(G__32075__a,0,null);
} 
...
var G__32078 = c;
var G__32078__$1 = (((G__32078 == null))?null:G__32078.constructor);
if((G__32078__$1 == null)){
return null;
} else {
return G__32078__$1.displayName;
}
});
...
var _STAR_current_component_STAR__orig_val__32079 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__32080 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__32080);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__32079);
}});
...
var c = this;
var G__32084_32086 = goog.object.get(c,"cljsRatom");
if((G__32084_32086 == null)){
} else {
reagent.ratom.dispose_BANG_(G__32084_32086);
}
...
var renders_32087 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender], null));
var render_fun_32088 = cljs.core.first(cljs.core.vals(renders_32087));
...
if((cljs.core.count(renders_32087) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_32087))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_32088)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_32088], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__32089 = o;
goog.object.set(G__32089,cljs.core.name(k),v);
