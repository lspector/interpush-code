...
return (new CustomEvent(event_name,(function (){var obj36045 = ({"detail":data});
return obj36045;
})()));
} else {
...
var f = (function (){var pred__36052 = cljs.core._EQ_;
var expr__36053 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__36052.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__36053))){
return (function (p1__36046_SHARP_){
return console.warn(p1__36046_SHARP_);
});
} else {
if(cljs.core.truth_(pred__36052.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__36053))){
return (function (p1__36047_SHARP_){
return console.debug(p1__36047_SHARP_);
});
} else {
if(cljs.core.truth_(pred__36052.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__36053))){
return (function (p1__36048_SHARP_){
return console.error(p1__36048_SHARP_);
});
} else {
return (function (p1__36049_SHARP_){
return console.log(p1__36049_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__36056){
...
var opts = map__36057__$1;
var eval_fn = cljs.core.get.call(null,map__36057__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__36059_SHARP_){
return new_def.callback(p1__36059_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__36060){
var vec__36061 = p__36060;
var ky = cljs.core.nth.call(null,vec__36061,(0),null);
var v = cljs.core.nth.call(null,vec__36061,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1593965205943
