...
var file = cljs.core.get.call(null,map__22953__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__22953__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__22953__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e22952){var _e = e22952;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___22955 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___22955)){
var seen_errors_22956 = temp__5733__auto___22955;
if(cljs.core.truth_(seen_errors_22956.has(self))){
} else {
seen_errors_22956.add(self);

var temp__5735__auto___22957 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___22957)){
var sense_22958 = temp__5735__auto___22957;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_22958)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1593791098103
