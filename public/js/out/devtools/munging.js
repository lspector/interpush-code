...
var o23081 = temp__5733__auto__;
var temp__5733__auto____$1 = (o23081["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o23082 = temp__5733__auto____$1;
return (o23082["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22916__auto__ = f;
return (o__22916__auto__["toString"]).call(o__22916__auto__);
} else {
return "";
}
}catch (e23083){var _ = e23083;
return "";
}});
...
try{var o__22916__auto___23085 = t;
(o__22916__auto___23085["cljs$lang$ctorPrWriter"]).call(o__22916__auto___23085,t,writer);
}catch (e23084){var __23086 = e23084;
}
...
var char_code = (function (){var o__22916__auto__ = (new String(char$));
return (o__22916__auto__["charCodeAt"]).call(o__22916__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22916__auto__ = String;
return (o__22916__auto__["fromCharCode"]).call(o__22916__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__23087 = num_code;
switch (G__23087) {
case (1):
return (185);
...
var o__22916__auto__ = String;
return (o__22916__auto__["fromCharCode"]).call(o__22916__auto__,superscript_code);
});
/**
...
}catch (e23089){var _e__22923__auto__ = e23089;
return false;
}})())){
...
var vec__23090 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__23090,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o23093 = temp__5733__auto__;
var temp__5733__auto____$1 = (o23093["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o23094 = temp__5733__auto____$1;
return (o23094["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___23101 = arguments.length;
var i__4737__auto___23102 = (0);
while(true){
if((i__4737__auto___23102 < len__4736__auto___23101)){
args__4742__auto__.push((arguments[i__4737__auto___23102]));

var G__23103 = (i__4737__auto___23102 + (1));
i__4737__auto___23102 = G__23103;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__23097){
var vec__23098 = p__23097;
var ns_detector = cljs.core.nth.call(null,vec__23098,(0),null);
...
var G__23104 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__23105 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__23104;
remaining_tokens = G__23105;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq23095){
var G__23096 = cljs.core.first.call(null,seq23095);
var seq23095__$1 = cljs.core.next.call(null,seq23095);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23096,seq23095__$1);
}));
...
var vec__23109 = cljs.core.split_with.call(null,(function (p1__23108_SHARP_){
return cljs.core.not_EQ_.call(null,p1__23108_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__23109,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__23109,(1),null);
...
var vec__23115 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__23115,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__23115,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__23118 = cljs.core.rest.call(null,remaining_tokens);
var G__23119 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__23118;
name_tokens = G__23119;
continue;
} else {
...
var vec__23122 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__23122,(0),null);
var arity = cljs.core.nth.call(null,vec__23122,(1),null);
var vec__23125 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__23125,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__23125,(1),null);
var vec__23128 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__23128,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__23128,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__23128,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__23128,(3),null);
...
var vec__23134 = result;
var munged_ns = cljs.core.nth.call(null,vec__23134,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__23134,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__23134,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__23134,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__23134,(4),null);
var arity = cljs.core.nth.call(null,vec__23134,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__23138 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__23138,(0),null);
var args = cljs.core.nth.call(null,vec__23138,(1),null);
var vec__23141 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__23141,(0),null);
var name = cljs.core.nth.call(null,vec__23141,(1),null);
...
var G__23144 = (arity + (1));
var G__23145 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__23146){
var vec__23147 = p__23146;
var arity = cljs.core.nth.call(null,vec__23147,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__23147,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23150_SHARP_){
return cljs.core.get.call(null,arities,p1__23150_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__23151_SHARP_){
return cljs.core.drop.call(null,(2),p1__23151_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__23154){
var vec__23155 = p__23154;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__23155,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq23152){
var G__23153 = cljs.core.first.call(null,seq23152);
var seq23152__$1 = cljs.core.next.call(null,seq23152);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__23153,seq23152__$1);
}));
...
var G__23161 = arg;
var G__23161__$1 = (((G__23161 instanceof cljs.core.Keyword))?G__23161.fqn:null);
switch (G__23161__$1) {
...
var map__23163 = options;
var map__23163__$1 = (((((!((map__23163 == null))))?(((((map__23163.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__23163.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__23163):map__23163);
var include_ns_QMARK_ = cljs.core.get.call(null,map__23163__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__23163__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__23163__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__23163__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__23164 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__23164,(0),null);
var fn_name = cljs.core.nth.call(null,vec__23164,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__23164,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__23164,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__23164,(4),null);
var arity = cljs.core.nth.call(null,vec__23164,(5),null);
...
var o__22916__auto__ = f;
return (o__22916__auto__["getBasis"]).call(o__22916__auto__);
});
/**
...
}catch (e23168){var _e__22923__auto__ = e23168;
...
var G__23169 = (obj[cljs.core.first.call(null,path)]);
var G__23170 = cljs.core.rest.call(null,path);
obj = G__23169;
path = G__23170;
continue;
} else {
...
var _STAR_ = (function (accum,p__23171){
var vec__23172 = p__23171;
var bit = cljs.core.nth.call(null,vec__23172,(0),null);
var protocol = cljs.core.nth.call(null,vec__23172,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__23175){
var vec__23176 = p__23175;
var ns = cljs.core.nth.call(null,vec__23176,(0),null);
var name = cljs.core.nth.call(null,vec__23176,(1),null);
var selector = cljs.core.nth.call(null,vec__23176,(2),null);
...
var post_process = (function (p__23180){
var vec__23181 = p__23180;
var munged_name = cljs.core.nth.call(null,vec__23181,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__23181,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__23179_SHARP_){
return (obj[cljs.core.first.call(null,p1__23179_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1593965183760
