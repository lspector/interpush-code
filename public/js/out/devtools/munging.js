...
var o22344 = temp__5733__auto__;
var temp__5733__auto____$1 = (o22344["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o22345 = temp__5733__auto____$1;
return (o22345["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22266__auto__ = f;
return (o__22266__auto__["toString"]).call(o__22266__auto__);
} else {
return "";
}
}catch (e22346){var _ = e22346;
return "";
}});
...
try{var o__22266__auto___22348 = t;
(o__22266__auto___22348["cljs$lang$ctorPrWriter"]).call(o__22266__auto___22348,t,writer);
}catch (e22347){var __22349 = e22347;
}
...
var char_code = (function (){var o__22266__auto__ = (new String(char$));
return (o__22266__auto__["charCodeAt"]).call(o__22266__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22266__auto__ = String;
return (o__22266__auto__["fromCharCode"]).call(o__22266__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22350 = num_code;
switch (G__22350) {
case (1):
return (185);
...
var o__22266__auto__ = String;
return (o__22266__auto__["fromCharCode"]).call(o__22266__auto__,superscript_code);
});
/**
...
}catch (e22352){var _e__22273__auto__ = e22352;
return false;
}})())){
...
var vec__22353 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22353,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o22356 = temp__5733__auto__;
var temp__5733__auto____$1 = (o22356["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o22357 = temp__5733__auto____$1;
return (o22357["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4736__auto___22364 = arguments.length;
var i__4737__auto___22365 = (0);
while(true){
if((i__4737__auto___22365 < len__4736__auto___22364)){
args__4742__auto__.push((arguments[i__4737__auto___22365]));

var G__22366 = (i__4737__auto___22365 + (1));
i__4737__auto___22365 = G__22366;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22360){
var vec__22361 = p__22360;
var ns_detector = cljs.core.nth.call(null,vec__22361,(0),null);
...
var G__22367 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22368 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22367;
remaining_tokens = G__22368;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22358){
var G__22359 = cljs.core.first.call(null,seq22358);
var seq22358__$1 = cljs.core.next.call(null,seq22358);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22359,seq22358__$1);
}));
...
var vec__22372 = cljs.core.split_with.call(null,(function (p1__22371_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22371_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22372,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22372,(1),null);
...
var vec__22378 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22378,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22378,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22381 = cljs.core.rest.call(null,remaining_tokens);
var G__22382 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22381;
name_tokens = G__22382;
continue;
} else {
...
var vec__22385 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22385,(0),null);
var arity = cljs.core.nth.call(null,vec__22385,(1),null);
var vec__22388 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22388,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22388,(1),null);
var vec__22391 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22391,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22391,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22391,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22391,(3),null);
...
var vec__22397 = result;
var munged_ns = cljs.core.nth.call(null,vec__22397,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22397,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22397,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22397,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22397,(4),null);
var arity = cljs.core.nth.call(null,vec__22397,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__22401 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__22401,(0),null);
var args = cljs.core.nth.call(null,vec__22401,(1),null);
var vec__22404 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22404,(0),null);
var name = cljs.core.nth.call(null,vec__22404,(1),null);
...
var G__22407 = (arity + (1));
var G__22408 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22409){
var vec__22410 = p__22409;
var arity = cljs.core.nth.call(null,vec__22410,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22410,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22413_SHARP_){
return cljs.core.get.call(null,arities,p1__22413_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__22414_SHARP_){
return cljs.core.drop.call(null,(2),p1__22414_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___22421 = arguments.length;
var i__4737__auto___22422 = (0);
while(true){
if((i__4737__auto___22422 < len__4736__auto___22421)){
args__4742__auto__.push((arguments[i__4737__auto___22422]));

var G__22423 = (i__4737__auto___22422 + (1));
i__4737__auto___22422 = G__22423;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22417){
var vec__22418 = p__22417;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22418,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22415){
var G__22416 = cljs.core.first.call(null,seq22415);
var seq22415__$1 = cljs.core.next.call(null,seq22415);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__22416,seq22415__$1);
}));
...
var G__22424 = arg;
var G__22424__$1 = (((G__22424 instanceof cljs.core.Keyword))?G__22424.fqn:null);
switch (G__22424__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22426__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22426__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22426__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22426__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22427 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22427,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22427,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22427,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22427,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22427,(4),null);
var arity = cljs.core.nth.call(null,vec__22427,(5),null);
...
var o__22266__auto__ = f;
return (o__22266__auto__["getBasis"]).call(o__22266__auto__);
});
/**
...
}catch (e22431){var _e__22273__auto__ = e22431;
...
var G__22432 = (obj[cljs.core.first.call(null,path)]);
var G__22433 = cljs.core.rest.call(null,path);
obj = G__22432;
path = G__22433;
continue;
} else {
...
var _STAR_ = (function (accum,p__22434){
var vec__22435 = p__22434;
var bit = cljs.core.nth.call(null,vec__22435,(0),null);
var protocol = cljs.core.nth.call(null,vec__22435,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22438){
var vec__22439 = p__22438;
var ns = cljs.core.nth.call(null,vec__22439,(0),null);
var name = cljs.core.nth.call(null,vec__22439,(1),null);
var selector = cljs.core.nth.call(null,vec__22439,(2),null);
...
var post_process = (function (p__22443){
var vec__22444 = p__22443;
var munged_name = cljs.core.nth.call(null,vec__22444,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22444,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__22442_SHARP_){
return (obj[cljs.core.first.call(null,p1__22442_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1627432837854
