...
var G__29393 = o;
goog.object.set(G__29393,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var args = cljs.core.seq(arglist__29396);
...
var G__29397 = o;
goog.object.set(G__29397,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__29401 = props;
var G__29401__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__29401,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__29401);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__29401__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__29401__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__29402 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__29402,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__29402;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__29403){
...
var on_write = cljs.core.get.call(null,map__29404__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__29406_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__29406_SHARP_);
}));
} else {
return null;
}
...
var vec__29409 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__29409,(0),null);
var id = cljs.core.nth.call(null,vec__29409,(1),null);
var className = cljs.core.nth.call(null,vec__29409,(2),null);
...
var temp__5739__auto___29413 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___29413 == null)){
} else {
var key_29414 = temp__5739__auto___29413;
(jsprops.key = key_29414);
}
...
var temp__5739__auto___29415 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___29415 == null)){
} else {
var key_29416 = temp__5739__auto___29415;
(jsprops.key = key_29416);
}
...
var temp__5739__auto___29417 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___29417 == null)){
} else {
var key_29418 = temp__5739__auto___29417;
(jsprops.key = key_29418);
}
...
var G__29420 = n;
if(cljs.core._EQ_.call(null,"",G__29420)){
return x;
} else {
if(cljs.core._EQ_.call(null,null,G__29420)){
return x;
} else {
...
var len__4736__auto___29423 = arguments.length;
var i__4737__auto___29424 = (0);
while(true){
if((i__4737__auto___29424 < len__4736__auto___29423)){
args__4742__auto__.push((arguments[i__4737__auto___29424]));

var G__29425 = (i__4737__auto___29424 + (1));
i__4737__auto___29424 = G__29425;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq29421){
var G__29422 = cljs.core.first.call(null,seq29421);
var seq29421__$1 = cljs.core.next.call(null,seq29421);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29422,seq29421__$1);
}));
...
break;
default:
var G__29428 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__29428;
continue;
...
var ctx = ({});
var vec__29430 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__29430,(0),null);
var derefed = cljs.core.nth.call(null,vec__29430,(1),null);
...
var G__29433 = (cljs.core.count.call(null,argv) - first_child);
switch (G__29433) {
case (0):
...
//# sourceMappingURL=template.js.map?rel=1593965194869
