...
var G__25397 = o;
goog.object.set(G__25397,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__25401 = o;
goog.object.set(G__25401,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__25402__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__25403__i < G__25403__a.length) {G__25403__a[G__25403__i] = arguments[G__25403__i + 0]; ++G__25403__i;}
  args = new cljs.core.IndexedSeq(G__25403__a,0,null);
} 
...
var args = cljs.core.seq(arglist__25404);
...
var G__25405 = props;
var G__25405__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__25405,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__25405);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25405__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__25405__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__25406 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__25406,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__25406;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__25407){
...
var on_write = cljs.core.get.call(null,map__25408__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__25410_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__25410_SHARP_);
}));
} else {
return null;
}
...
var vec__25413 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__25413,(0),null);
var id = cljs.core.nth.call(null,vec__25413,(1),null);
var className = cljs.core.nth.call(null,vec__25413,(2),null);
...
var temp__5739__auto___25417 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___25417 == null)){
} else {
var key_25418 = temp__5739__auto___25417;
(jsprops.key = key_25418);
}
...
var temp__5739__auto___25419 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___25419 == null)){
} else {
var key_25420 = temp__5739__auto___25419;
(jsprops.key = key_25420);
}
...
var temp__5739__auto___25421 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___25421 == null)){
} else {
var key_25422 = temp__5739__auto___25421;
(jsprops.key = key_25422);
}
...
var G__25424 = n;
if(cljs.core._EQ_.call(null,"",G__25424)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq25425){
var G__25426 = cljs.core.first.call(null,seq25425);
var seq25425__$1 = cljs.core.next.call(null,seq25425);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__25426,seq25425__$1);
}));
...
break;
default:
var G__25432 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__25432;
continue;
...
var ctx = ({});
var vec__25434 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__25434,(0),null);
var derefed = cljs.core.nth.call(null,vec__25434,(1),null);
...
var G__25437 = (cljs.core.count.call(null,argv) - first_child);
switch (G__25437) {
case (0):
...
//# sourceMappingURL=template.js.map?rel=1593791104892
