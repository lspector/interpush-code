...
return cljs.core.reduce.call(null,(function (result,p__24586){
...
var vec__24590 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__24590,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__24590,(1),null);
var ab = cljs.core.nth.call(null,vec__24590,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_24596 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_24596.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_24597 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_24597.call(null,a,b);
}
});
...
return (function (){var G__24601 = clojure.data.equality_partition.call(null,a);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24601__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1593791102360
