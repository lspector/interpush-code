...
return cljs.core.reduce.call(null,(function (result,p__24587){
...
var vec__24591 = clojure.data.diff.call(null,va,vb);
var a_STAR_ = cljs.core.nth.call(null,vec__24591,(0),null);
var b_STAR_ = cljs.core.nth.call(null,vec__24591,(1),null);
var ab = cljs.core.nth.call(null,vec__24591,(2),null);
...
var clojure$data$EqualityPartition$equality_partition$dyn_24597 = (function (x){
...
return clojure$data$EqualityPartition$equality_partition$dyn_24597.call(null,x);
}
});
...
var clojure$data$Diff$diff_similar$dyn_24598 = (function (a,b){
...
return clojure$data$Diff$diff_similar$dyn_24598.call(null,a,b);
}
});
...
return (function (){var G__24602 = clojure.data.equality_partition.call(null,a);
var G__24602__$1 = (((G__24602 instanceof cljs.core.Keyword))?G__24602.fqn:null);
switch (G__24602__$1) {
case "atom":
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__24602__$1)].join('')));
...
//# sourceMappingURL=data.js.map?rel=1593965186634
